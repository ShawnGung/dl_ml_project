...
if __name__ == "__main__":
    ...
    data_dir = TASKB_DATA_DIR
    output_dir = "output/taskb_output/" 
    cache_dir = "output/taskb_cache"
    log_dir = "output/taskb_log/" 
...
#     bert_model_dir = "/search/hadoop02/suanfa/songyingxin/pytorch_Bert/bert-large-uncased"
    ...
    from Processors.TASKBProcessor import TaskbProcessor
