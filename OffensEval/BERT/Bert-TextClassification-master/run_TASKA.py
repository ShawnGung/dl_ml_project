...
if __name__ == "__main__":
    ...
    data_dir = TASKA_DATA_DIR
    output_dir = "output/taska_output/" 
    cache_dir = "output/taska_cache"
    log_dir = "output/taska_log/" 
...
#     bert_model_dir = "/search/hadoop02/suanfa/songyingxin/pytorch_Bert/bert-large-uncased"
    ...
    from Processors.TASKAProcessor import TaskaProcessor
